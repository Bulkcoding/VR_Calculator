...
export default function WatchlistPage() {
  ...
  return (
    <DashboardShell title="관심종목" hideBrand>
                ...
                results.map((r) => {
                  ...
                  return (
                    <div key={r.ticker} className="flex items-center gap-3 px-3 py-2.5 hover:bg-gray-50 transition">
                      <div className="theme-gradient-badge w-8 h-8 rounded-lg flex items-center justify-center text-[10px] font-extrabold shrink-0 shadow-md">
